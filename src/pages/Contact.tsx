        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div>
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
              Contact Fresh View Flavours
            </h2>
            <p className="mt-4 text-lg text-gray-500">
              We'd love to hear from you! Whether you have a question about our products, 
              want to discuss bulk orders, or are interested in our farming practices, 
            ...
            <div className="mt-8 space-y-6">
              <div className="flex items-center">
                ...
                <span className="ml-3 text-gray-700">+254 748 430 822</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="ml-3 text-gray-700">info@freshviewflavours.co.ke</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="ml-3 text-gray-700">Mia Moja Timau, Mount Kenya</span>
              </div>
            </div>
          </div>
